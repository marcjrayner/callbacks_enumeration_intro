...
describe('Cinema', function () {
  ...
  it('should be able to check if some films from a particular year', function () {
    const actual = cinema.checkIfFilmsFrom(2018);
    assert.deepStrictEqual(actual, true)
  });

  it('should be able to check if no films from a particular year', function () {
    const actual = cinema.checkIfFilmsFrom(2020);
    assert.deepStrictEqual(actual, false)
  });


  it('should be able to check whether all films are over a particular length', function () {
    const actual = cinema.checkAllFilmsOver(90)
    assert.deepStrictEqual(actual, true)
  });
